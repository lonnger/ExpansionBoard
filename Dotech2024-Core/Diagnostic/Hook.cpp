...
static inline void stopAllMotors()
{
     ...
     * @hint    you can try to set all the motors' current / voltage to 0, do not forget to send this command.
     */
}
...
extern "C"
{
    ...
    void __cxa_pure_virtual(void)
    {
        ...
        /**
         *      What are you doing??? How you pass the compilation???? Check your code!!!
         **/
    }
